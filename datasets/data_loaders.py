...
from .kitti_dataset import KITTINMPairDataset, KITTIPairDataset, KITTINMPairTestDataset
from .kitti import KITTIDataset

ALL_DATASETS = [ThreeDMatchPairDataset, ThreeDMatchTestDataset, ThreeDLoMatchTestDataset, KITTIDataset ,KITTIPairDataset,KITTINMPairDataset, KITTINMPairTestDataset]

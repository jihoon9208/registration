...
class ThreeDMatchPairDataset(BasicDataset):
    ...
    OVERLAP_RATIO = 0.3
    DATA_FILES = {
      'train': './datasets/split/vkitti/train_vkitti.txt',
      'val': './datasets/split/vkitti/val_vkitti.txt',
      'test': './datasets/split/vkitti/test_vkitti.txt'
    }
    def __init__(self,
               phase,
               transform=None,
...
class ThreeDMatchTestDataset(Dataset):
    ...
    DATA_FILES = {"test": "./datasets/split/vkitti/test_vkitti.txt"}
